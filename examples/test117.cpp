...
int main() {
    UnlabeledValueArg<int> a({.name = "count",
                              .description = "a count",
                              .required = true,
                              .defaultValue = 0,
                              .typeDesc = "int"});
    UnlabeledValueArg<int> sameName({.name = "count",
                                     .description = "different description",
                                     .required = true,
                                     .defaultValue = 0,
                                     .typeDesc = "int"});
    UnlabeledValueArg<int> sameDescription({.name = "other",
                                            .description = "a count",
                                            .required = true,
                                            .defaultValue = 0,
                                            .typeDesc = "int"});
    UnlabeledValueArg<int> different({.name = "other",
                                      .description = "different description",
                                      .required = true,
                                      .defaultValue = 0,
                                      .typeDesc = "int"});
